...
package com.example.libzxing.camera;
...
import com.example.libzxing.camera.open.OpenCameraInterface;
...
public class CameraManager {
    ...
    public void openLight() {
        ...
        if (Camera.Parameters.FLASH_MODE_OFF.equals(parameters.getFlashMode())) {
            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);//开
